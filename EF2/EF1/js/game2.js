...
function maraQuest() {
  ...
  if (q.step === 1 && q.kills >= 4)
    return showModal(
      'Mara',
      'The supply carts arrived safely. This Frostmere buckler belonged to the old road watch. Carry it with our thanks.',
      [
        [
          'Complete quest',
          () => {
...
function willowElder() {
  ...
  if (q.step === 0)
    return showModal(
      'Elder Willow',
      'Wild boars are tearing through our winter stores. Drive back three of them and Thornwood will remember your help.',
      [
        [
          'Begin The Boar Hunt',
          () => {
  ...
  if (q.step === 1 && q.kills >= 3)
    return showModal(
      'Elder Willow',
      'The eastern hedge is quiet again. Take this mantle, woven in Thornwood, with our thanks.',
      [
        [
          'Complete quest',
          () => {
...
function rowan() {
  ...
  if (s.q === 1 && s.step === 0) {
    ...
    showModal(
      'Captain Rowan',
      'These markings... I have only ever seen them in the old Warden records. They are the Ember\'s own brand, seared into whatever crawls too near the buried fire. It is worse than I feared. Take my blade — you have earned it — and ride east to Cinderforge. Find Scholar Mira; she is the last who still reads the Warden lore. If anyone can make sense of you, and of what stirs below, it is her.',
      [
        [
          'Take the blade',
          () => {
